...
// UpdateContractMetadataChangeset updates existing contract metadata entries in the Datastore.
...
// Apply executes the changeset, updating the contract metadata in the Datastore.
