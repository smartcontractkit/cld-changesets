...
// UpdateAddressRefChangeset updates existing address ref entries in the Datastore.
...
// Apply executes the changeset, updating the address refs in the Datastore.
