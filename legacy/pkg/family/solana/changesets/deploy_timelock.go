...
func deployTimelockProgram(
	...
	typeAndVersion := cldf.NewTypeAndVersion(mcmscontracts.RBACTimelockProgram, semvers.V1_0_0)
...
func initTimelock(
	...
	typeAndVersion := cldf.NewTypeAndVersion(mcmscontracts.RBACTimelock, semvers.V1_0_0)
