...
// CREWorkflowDeleteInput is the resolved input for a CRE workflow delete.
// Project is resolved via [creartifacts.ArtifactsResolver]. Binary and config are not used.
