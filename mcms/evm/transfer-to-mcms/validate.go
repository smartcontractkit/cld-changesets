...
func validateMCMS(env cldf.Environment, in transfertomcms.ChainInput) error {
	if in.MCMS == nil {
...
func validateContracts(env cldf.Environment, in transfertomcms.ChainInput) error {
...
func timelockAddress(env cldf.Environment, in transfertomcms.ChainInput) (common.Address, error) {
	if in.MCMS == nil {
...
// validateContractOwner enforces ownership preconditions for transfer-to-MCMS.
